...
static void motion_task(void *param)
{
    ...
    char buf[64];
    for (;;) {
        EventBits_t bits =  xEventGroupWaitBits(motionEventGroup,MOTION_GET_DATA_BIT  | MOTION_GET_SETP_BIT, pdFALSE, pdFALSE, portMAX_DELAY);
